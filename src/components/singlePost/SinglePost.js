...
const SinglePost = () => {
    ...
    useEffect(() => {
        ...
        const res = await axios.get(`https://blog-app-mern-api.herokuapp.com/api/post/${postId}`);
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`https://blog-app-mern-api.herokuapp.com/api/post/delete/${postId}`);
    ...
    const sendUpdatedPost = async()=>{
        try{
            await axios.put(`https://blog-app-mern-api.herokuapp.com/api/post/update/${postId}`,{
                title,
                description
            })
